...
import { ADD_STUDENT, REMOVE_MAJOR, REMOVE_STUDENT, SET_STUDENT_NAME } from '../utils/actions';
...
import { SET_STUDENT_NAME } from '../utils/actions';
...
export default function StudentList() {
  ...
  const stateDispatch = useReducer(initialState);
            ...
            <div className="add-student">
              ...
              <button
                ...
                onClick={() => {
                  ...
                  dispatch({ type: ADD_MAJOR, payload: { name: state.studentName, major: state.studentMajor} })
                }}
              >
                Add Student
              </button>
